...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./blackcoin-util":
        execprog = os.getenv("BLACKCOINUTIL", default=os.getenv("BITCOINUTIL", default=execprog))
    elif testObj["exec"] == "./blackcoin-tx":
        execprog = os.getenv("BLACKCOINTX", default=os.getenv("BITCOINTX", default=execprog))
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, blackcoin-tx
