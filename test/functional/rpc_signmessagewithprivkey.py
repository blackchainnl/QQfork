...
class SignMessagesWithPrivTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Message signatures commit to this fork's message magic, not Bitcoin's.
        expected_signature = 'IBQeh1VVZO6Xbu+FYeemZOynGERigKSHZQuJrCYCUBm1Mgfoi9D8E3kFZgzFaOBvRVkFgBohNZR8sRQ++luyNyc='
