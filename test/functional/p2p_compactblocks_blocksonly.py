...
# Copyright (c) 2021-2021 Blackcoin Core Developers
# Copyright (c) 2021-2021 Blackcoin More Developers
# Copyright (c) 2021-2021 Blackcoin Developers
...
class P2PCompactBlocksBlocksOnly(BitcoinTestFramework):
    def set_test_params(self):
        self.extra_args = [["-blocksonly"], [], ["-rpcserialversion=1"], []]
        self.num_nodes = 4
    ...
    def run_test(self):
        ...
        p2p_conn_blocksonly = self.nodes[0].add_p2p_connection(P2PInterface(), services=self.p2p_services)
        p2p_conn_high_bw = self.nodes[1].add_p2p_connection(P2PInterface(), services=self.p2p_services)
        p2p_conn_low_bw = self.nodes[3].add_p2p_connection(P2PInterface(), services=self.p2p_services)
