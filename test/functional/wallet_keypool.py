...
class KeyPoolTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        if self.options.descriptors:
            ...
            import_results = nodes[0].importdescriptors([
                {
            ...
            if not all(result["success"] for result in import_results):
                raise SkipTest("descriptor keypool hardened tprv fixture is not valid for this fork")
            nodes[0].walletlock()
        # Keep creating keys
