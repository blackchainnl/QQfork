...
EXTENDED_SCRIPTS = [
    ...
    # These inherited tests prepare thousands of synthetic blocks or script
    # vectors; they are slow even though regtest header PoW remains trivial.
    'feature_taproot.py',
    'feature_assumevalid.py',
    'p2p_ibd_stalling.py',
    'p2p_ibd_stalling.py --v2transport',
    'feature_quantum_integration_soak.py',
    'feature_quantum_demurrage_soak.py',
    'feature_dbcrash.py',
]
...
BASE_SCRIPTS = [
    ...
    'wallet_pos_v2_template_time.py',
    'wallet_multiwallet.py --usecli',
    'p2p_dns_seeds.py',
    'wallet_groups.py --legacy-wallet',
    'wallet_groups.py --descriptors',
    'p2p_blockfilters.py',
    'feature_blackcoin_phase.py',
    'feature_quantum_activation_boundary.py',
    'feature_quantum_coldstaking.py',
    'feature_quantum_staking_tiers.py',
    'feature_quantum_stake_reward_split.py',
    'feature_quantum_pool_cap.py',
    'feature_quantum_redelegation.py',
    'feature_quantum_redelegation_auto.py',
    'feature_quantum_demurrage.py',
    ...
    'feature_chainstate_rebuild_lifecycle.py',
    'feature_reindex.py',
    ...
    'mempool_reorg.py',
    'mempool_reorg_v2_time_unavailable.py',
    'p2p_block_sync.py',
    ...
    'rpc_goldrushinfo.py',
    'rpc_rgb.py',
    'wallet_rgb_consignment.py',
    'wallet_rgb_persistence.py',
    'wallet_rgb_seal_protection.py',
    'wallet_rgb_reconcile.py',
    'wallet_rgb_transfer.py',
    'wallet_disable.py',
    ...
    'mining_basic.py',
    'mining_getblocktemplate_cached_time.py',
    'feature_signet.py',
...
def run_tests(*, test_list, src_dir, build_dir, tmpdir, jobs=1, enable_coverage=False, args=None, combined_logs_len=0, failfast=False, use_term_control):
    ...
    # Warn if blackcoind is already running
    try:
        # pgrep exits with code zero when one or more matching processes found
        if subprocess.run(["pgrep", "-x", "blackcoind"], stdout=subprocess.DEVNULL).returncode == 0:
            print("%sWARNING!%s There is already a blackcoind process running on this system. Tests may fail unexpectedly due to resource contention!" % (BOLD[1], BOLD[0]))
    except OSError:
        # pgrep not supported
        pass
