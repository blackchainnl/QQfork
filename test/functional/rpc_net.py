#!/usr/bin/env python3
# Copyright (c) 2017-present Blackcoin Core Developers
# Copyright (c) 2017-present Blackcoin More Developers
# Copyright (c) 2017-present Blackcoin Developers
...
class NetTest(BitcoinTestFramework):
    ...
    def test_getpeerinfo(self):
        ...
        assert peer_info[0][0]['minfeefilter'] >= self.nodes[1].getnetworkinfo()['relayfee']
        assert peer_info[1][0]['minfeefilter'] >= self.nodes[0].getnetworkinfo()['relayfee']
    ...
    def test_getnodeaddresses(self):
        ...
        expected_addr_services = P2P_SERVICES | NODE_WITNESS
        ...
        for a in node_addresses:
            ...
            assert_equal(a["services"], expected_addr_services)
        ...
        assert_equal(res[0]["services"], expected_addr_services)
                ...
                "entries": [
                    {
                        "address": "2.0.0.0",
                        "port": 15714,
                        "services": expected_addr_services,
                        "network": "ipv4",
                        "source": "2.0.0.0",
                        "source_network": "ipv4",
                    }
