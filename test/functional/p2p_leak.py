...
class P2PLeakTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].bumpmocktime(PEER_TIMEOUT + 1)
        ...
        no_version_idle_peer.wait_for_disconnect(timeout=5)
        no_verack_idle_peer.wait_for_disconnect(timeout=5)
        pre_wtxidrelay_peer.wait_for_disconnect(timeout=5)
