...
class MempoolPersistTest(BitcoinTestFramework):
    ...
    def run_test(self):
        if "prioritisetransaction" not in self.nodes[0].help():
            raise SkipTest("priority persistence requires prioritisetransaction, which this fork build does not expose")
