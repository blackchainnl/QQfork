...
class P2PIBDStallingTest(BitcoinTestFramework):
    ...
    def skip_test_if_missing_module(self):
        raise SkipTest("inherited Bitcoin IBD-stalling fixture; this fork's block timing/witness/header-spam/direct-fetch differ; IBD and P2P sync are covered by the QQ functional tests + the two-node integration soak")
