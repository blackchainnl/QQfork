...
class ReceivedByTest(BitcoinTestFramework):
    ...
    def ensure_receiver_has_tx(self, txid):
        if txid not in self.nodes[1].getrawmempool():
    ...
    def run_test(self):
        ...
        self.ensure_receiver_has_tx(txid)
        ...
        reward = self.nodes[0].getblock(blockhash=hash, verbosity=2)["tx"][0]["vout"][0]["value"]
