...
class TransactionTimeRescanTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        start_height = minernode.getblockcount()
        ...
        assert_equal(minernode.getblockcount(), start_height + initial_mine)
        ...
        height_after_wo1 = start_height + initial_mine + COINBASE_MATURITY
        assert_equal(minernode.getblockcount(), height_after_wo1)
        ...
        # generate blocks and check blockcount
        self.generatetoaddress(minernode, COINBASE_MATURITY, m1)
        height_after_wo2 = height_after_wo1 + COINBASE_MATURITY
        assert_equal(minernode.getblockcount(), height_after_wo2)
        ...
        self.generatetoaddress(minernode, COINBASE_MATURITY, m1)
        height_after_wo3 = height_after_wo2 + COINBASE_MATURITY
        assert_equal(minernode.getblockcount(), height_after_wo3)
        ...
        restorewo_wallet.rescanblockchain(height_after_wo1 + 1)
        ...
        if not self.options.descriptors:
            ...
            expected_stop_height = minernode.getblockcount()
            ...
            with concurrent.futures.ThreadPoolExecutor(max_workers=1) as thread:
                ...
                assert_equal(rescanning.result(), {"start_height": 0, "stop_height": expected_stop_height})
