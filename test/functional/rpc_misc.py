...
class RpcMiscTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # This fork enables txindex by default, so the no-extra-index baseline
        # contains only txindex instead of Bitcoin Core's empty object.
        txindex_values = {"synced": True, "best_block_height": 200}
        assert_equal(node.getindexinfo(), {"txindex": txindex_values})
