...
QUANTUM_QUASAR_MIN_TX_FEE = 10000
QUANTUM_QUASAR_TX_FEE_PER_VB = 100
...
def get_quantum_quasar_min_tx_fee(tx):
    """Return this fork's post-V3.1 consensus fee floor for a transaction.

    Mirrors src/consensus/tx_verify.cpp:GetMinFee(): 10,000 sat minimum for
    <=100 vB, otherwise 100 sat/vB. Use for hand-built test transactions that
    bypass wallet/miner fee selection.
    """
    return max(QUANTUM_QUASAR_MIN_TX_FEE, QUANTUM_QUASAR_TX_FEE_PER_VB * tx.get_vsize())
