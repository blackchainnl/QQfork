...
# Copyright (c) 2017-2019 Blackcoin Core Developers
# Copyright (c) 2017-2019 Blackcoin More Developers
# Copyright (c) 2017-2019 Blackcoin Developers
...
class RPCWhitelistTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        with open(self.nodes[0].datadir_path / "blackcoin.conf", "a", encoding="utf8") as f:
