    ...
    return RPCHelpMan{"getwalletinfo",
                ...
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        ...
                        {RPCResult::Type::BOOL, "quantum_keys", "whether this wallet contains wallet-managed Blackcoin ML-DSA private keys"},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    obj.pushKV("quantum_keys", pwallet->IsWalletFlagSet(WALLET_FLAG_QUANTUM_KEYS));
...
Span<const CRPCCommand> GetWalletRPCCommands()
{
    static const CRPCCommand commands[]{
        ...
        {"wallet", &abortrescan},
        {"wallet", &acceptrgbconsignment},
        {"wallet", &addmultisigaddress},
        {"wallet", &backupwallet},
        {"wallet", &burn},
        {"wallet", &burnwallet},
        {"wallet", &creatergbtransfer},
        {"wallet", &createwallet},
        {"wallet", &restorewallet},
        {"wallet", &deladdressbook},
        {"wallet", &dumpprivkey},
        {"wallet", &dumpquantumkey},
        {"wallet", &dumpwallet},
        {"wallet", &encryptwallet},
        {"wallet", &exportrgbconsignment},
        ...
        {"wallet", &importquantumcoldstakingdelegation},
        {"wallet", &importquantumkey},
        {"wallet", &importrgbassignment},
        {"wallet", &importrgbcontract},
        {"wallet", &importeutxostate},
        {"wallet", &importpubkey},
        {"wallet", &importwallet},
        {"wallet", &keypoolrefill},
        {"wallet", &listeutxostates},
        ...
        {"wallet", &listquantumcoldstakingdelegations},
        {"wallet", &listquantumaddresses},
        {"wallet", &listrgbassets},
