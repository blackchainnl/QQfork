...
std::string ScriptErrorString(const ScriptError serror)
{
    switch (serror)
    {
        ...
        case SCRIPT_ERR_ML_DSA_SIG_SIZE:
            return "Invalid ML-DSA signature size";
        case SCRIPT_ERR_ML_DSA_PUBKEY_SIZE:
        ...
        case SCRIPT_ERR_QUANTUM_COLDSTAKE_NOT_COINSTAKE:
            return "Quantum cold-stake staker branch used outside a coinstake";
        case SCRIPT_ERR_QUANTUM_COLDSTAKE_OWNER_COINSTAKE:
            return "Quantum cold-stake owner branch cannot be used inside a coinstake";
        case SCRIPT_ERR_EUTXO_LEGACY_SIGOP:
            return "Legacy signature opcode is disabled in EUTXO validators after final lockout";
