...
/** Maximum script element size for legacy consensus and policy paths. */
static const unsigned int MAX_SCRIPT_ELEMENT_SIZE = 520;

/** Maximum script element size after the V4 protocol upgrade. */
static const unsigned int V4_MAX_SCRIPT_ELEMENT_SIZE = 4096;
