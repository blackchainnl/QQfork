...
public:
    CMainParams() {
        ...
        // Quantum Quasar V4 readiness signalling. Consensus activation is governed by the
        // explicit hard-fork schedule below; this bit advertises upgraded miner/node readiness.
        consensus.vDeployments[Consensus::DEPLOYMENT_QUANTUM_QUASAR].bit = 3;
        consensus.vDeployments[Consensus::DEPLOYMENT_QUANTUM_QUASAR].nStartTime = 1713938400;
...
public:
    explicit CTestNetParams(const TestNetOptions& opts) {
        ...
        // Quantum Quasar readiness signalling mirrors mainnet so public testnet nodes can
        // advertise upgrade readiness without altering the deterministic hard-fork schedule.
        consensus.vDeployments[Consensus::DEPLOYMENT_QUANTUM_QUASAR].bit = 3;
        consensus.vDeployments[Consensus::DEPLOYMENT_QUANTUM_QUASAR].nStartTime = 1713938400;
        consensus.vDeployments[Consensus::DEPLOYMENT_QUANTUM_QUASAR].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
        consensus.vDeployments[Consensus::DEPLOYMENT_QUANTUM_QUASAR].min_activation_height = 0;
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_QUANTUM_QUASAR].bit = 3;
        consensus.vDeployments[Consensus::DEPLOYMENT_QUANTUM_QUASAR].nStartTime = Consensus::BIP9Deployment::ALWAYS_ACTIVE;
        consensus.vDeployments[Consensus::DEPLOYMENT_QUANTUM_QUASAR].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
        consensus.vDeployments[Consensus::DEPLOYMENT_QUANTUM_QUASAR].min_activation_height = 0;

        consensus.vDeployments[Consensus::DEPLOYMENT_QUANTUM_MIGRATION].bit = 4;
        consensus.vDeployments[Consensus::DEPLOYMENT_QUANTUM_MIGRATION].nStartTime = Consensus::BIP9Deployment::ALWAYS_ACTIVE;
        consensus.vDeployments[Consensus::DEPLOYMENT_QUANTUM_MIGRATION].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
        consensus.vDeployments[Consensus::DEPLOYMENT_QUANTUM_MIGRATION].min_activation_height = 0;
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        consensus.nProtocolV3Time = 1444028400;
        consensus.nProtocolV3_1Time = 1713938400;
        consensus.nProtocolV4Time = 0; // V4 active from genesis on regtest
        // Default to a perpetual Gold Rush with no migration/lockout, so existing tests are
        // unaffected. Functional tests opt into Migration/Final-Lockout by overriding these
        // via -qqgoldrushendtime / -qqmigrationdeadlinetime (see ReadRegTestArgs). A value of
        ...
        for (const auto& [height, hash] : opts.checkpoint_overrides) {
        ...
        m_assumeutxo_data = {
            {
                .height = 110,
                .hash_serialized = AssumeutxoHash{uint256S("0x2e5010fbefbf7877ff73beb12b98554fb142b61946616a284e34ff9221144e27")},
                .nChainTx = 111,
                .blockhash = uint256S("0xe50b8be6b543975e2f5e7b7b43f87ffe6c2bb1f7be29c8732c5a8debeb9ca5a2")
            },
            {
                // For use by test/functional/feature_assumeutxo.py
                .height = 299,
                .hash_serialized = AssumeutxoHash{uint256S("0xc77dbcdc4a4a6f4f59d535ad1f4c449d056b63185b7ac3e0c916f6d4683c4066")},
                .nChainTx = 300,
                .blockhash = uint256S("0x57570504838bf284a502466dd6791f01a5780f1d4015494ae4544da24cb3b610")
            },
        };
