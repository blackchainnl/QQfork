...
const std::vector<std::string> RPC_COMMANDS_SAFE_FOR_FUZZING{
    ...
    "converttopsbt",
    "createcoldstakingaddress",
    "createeutxospend",
    "createeutxotransition",
    "createquantumkey",
    ...
    "signrawblockwithquantumkey",
    "signrawtransactionwithkey",
    "signrawtransactionwithquantumkey",
    "submitblock",
    "submitheader",
    "submitpackage",
    "submitquantumpoolclaim",
