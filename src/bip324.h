...
private:
    ...
    void InitializeInternal(const EllSwiftPubKey& their_pubkey, bool initiator, Span<const unsigned char> message_start, bool self_decrypt) noexcept;
...
public:
    ...
    void InitializeForTest(const EllSwiftPubKey& their_pubkey, bool initiator, Span<const unsigned char> message_start, bool self_decrypt = false) noexcept;
